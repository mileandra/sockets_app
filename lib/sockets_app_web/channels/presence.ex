defmodule SocketsAppWeb.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule SocketsApp.MyChannel do
  ...
  use Phoenix.Presence, otp_app: :sockets_app,
                        pubsub_server: SocketsApp.PubSub
  ...
  def fetch(_topic, entries) do
    ...
    for {key, %{metas: metas}} <- entries, into: %{} do
      {key, %{metas: metas, user: Map.get(users, key)}}
    end
  end
